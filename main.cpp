...
int main()
{
    ...
    while (cycle > 0) {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            switch (win) {
                case 2:
                    cout << "Name your " << player.team[player.currentSN - 1].species << ":\n";
                    getline(cin,name);
                    if (name == "") {
                        name = player.team[player.currentSN - 1].species;
                    }
                    player.team[player.currentSN - 1].set_name(name);
        ...
        player.print_team();
        player.resetPtcp();
        while (win != -2 && oppo.currentOut != oppo.size - 1 && win != 1) {
